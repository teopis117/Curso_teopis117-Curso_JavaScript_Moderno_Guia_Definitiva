...
// el operador && es igual a la puerta logica AND donde las dos condiciones deben de ser verdaderas para ejecutarse
...
if (usuario && puedePagar) {
    console.log('Tu Pedido se hizo con éxito...');
    // en el caso que usuario no sea verdadero ejecutara esto
} else if (!usuario) {
    console.log('Inicia sesión para realizar el pedido')
} else if(!puedePagar) {
    console.log('Fondos Insuficientes')
} 
    // el caso donde no cayo en ninguna haya caido en los else if
else {
    console.log('hubo un error con tu pago.')
}
